...
@section('title')
  ...
  <title>Matrix CS:GO | Not just play - build network and earn money</title>
...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/L10002/css/c.css?rand={!! mt_rand(1000,9999); !!}">
  <link rel="stylesheet" type="text/css" href="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10008/css/c.css?rand={!! mt_rand(1000,9999); !!}">
  <!-- document css: stop -->
...
@section('js')
  ...
  <script src="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/L10002/js/j.js?rand={!! mt_rand(1000,9999); !!}"></script>
  <script src="{!! (\Request::secure() ? "https://" : "http://") . (\Request::getHost()) . ":" . (\Request::getPort()); !!}/public/D10008/js/j.js?rand={!! mt_rand(1000,9999); !!}"></script>
  <!-- document js: stop -->
