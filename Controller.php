 ...
 *
 *                  POST-API1   D10008:1              (v)      Описание
 *                  POST-API2   D10008:2              (v)      Описание
 *
 *
 *
 */
...
class Controller extends BaseController {
  ...
  //-------------------------------------------------//
  public $packid = "D10008";
  public $layoutid = "L10002";
  ...
  public function postIndex() {
    ...
    //------------------------//
      ...
      //------------------------------------------//
      // - $key       - ключ операции (напр.: D10008:1)
      ...
      if(!empty($key) && empty($command)) {
        ...
        //-----------------------------//
        // Нестандартная операция D10008:1 //
        //-----------------------------//
        if($key == 'D10008:1') {
