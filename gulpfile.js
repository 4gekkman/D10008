...
// 3. Получить необходимые данные от suf_watch_setting
    ...
    sources["assets"] = [
      "../L10002/Public/assets/**/*.*", 
      "../D10008/Public/assets/**/*.*", 
    ];
    // sources: end
	...
	dests['php'] = [];
		...
		// dests: start
    dests["styles"] = [
      "../../../public/public/L10002/css", 
      "../../../public/public/D10008/css", 
    ];
    dests["javascript"] = [
      "../../../public/public/L10002/js", 
      "../../../public/public/D10008/js", 
    ];
    dests["assets"] = [
      "../../../public/public/L10002/assets", 
      "../../../public/public/D10008/assets", 
    ];
    dests["php"] = [
      "../L10002/**/*.php", 
      "../D10008/**/*.php", 
